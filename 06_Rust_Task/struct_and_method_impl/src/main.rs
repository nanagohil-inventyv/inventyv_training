...
fn main() {
    ...
    user.set_username("shivam@123".to_string());
    user.set_display_name("Shivam Gohil".to_string());
    user.set_status("busy".to_string());
    ...
    println!("{}", user.get_user_info());

    println!(
        "{}",
        user.get_user_info_with_args(
            2,
            "john",
            "John Doe",
            "US",
